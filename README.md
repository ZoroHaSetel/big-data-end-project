...
Pointer need update
- Big data component include minio and spark, but it is not scalable and not production ready
- Minio can scale horizontally by adding more minio server similar to hadoop
- Spark can scale horizontally by adding more spark worker
